    ...
    <div className="min-h-screen bg-gray-50 flex">
      <aside className="hidden md:flex flex-col w-60 bg-white border-r border-gray-100 p-4 shrink-0">
        ...
        <div className="border-t border-gray-100 pt-4 space-y-2">
          ...
          <NavLink
            to="/"
            className="sidebar-link text-gray-600 hover:bg-gray-50"
          >
        ...
        {[
          {
            ...
            val: stats?.pendingVendors || 0,
            color: 'text-orange-600',
            link: '/admin/vendors',
          },
          {
            label: 'Verified Vendors',
            val: stats?.verifiedVendors || 0,
            color: 'text-green-600',
            link: '/admin/vendors',
          },
          {
            label: 'Completed Bookings',
            val: stats?.completedBookings || 0,
            color: 'text-brand',
            link: '/admin/bookings',
          },
